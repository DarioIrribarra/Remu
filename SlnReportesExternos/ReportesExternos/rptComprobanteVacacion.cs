...
namespace ReportesExternos
{
    public partial class rptComprobanteVacacion : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private void xrLabel19_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            string celda = GetCurrentColumnValue("rut") == null ? "11.111.111-1" : GetCurrentColumnValue("rut").ToString();
        ...
        {
            string data = GetCurrentColumnValue("tipo") == null ? "1" : GetCurrentColumnValue("tipo").ToString();
            if (data == "1")
            {
        ...
        {
            string dato = GetCurrentColumnValue("dias") == null ? "0.0" : GetCurrentColumnValue("dias").ToString();
            string tipoVacaciones = GetCurrentColumnValue("tipo") == null ? "tipo vacaciones" : GetCurrentColumnValue("tipo").ToString();
        ...
        private void xrTableCell83_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            //Dias usados..
            double dias = GetCurrentColumnValue("dias") == null ? 0.0 : Convert.ToDouble(GetCurrentColumnValue("dias").ToString());
            string tipoVacaciones = GetCurrentColumnValue("tipo") == null ? "tipo vacaciones" : GetCurrentColumnValue("tipo").ToString();
        ...
        private void xrTableCell99_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            decimal dias = GetCurrentColumnValue("dias") == null ? Convert.ToDecimal("0.0") : Convert.ToDecimal(GetCurrentColumnValue("dias").ToString());
            string tipoVacaciones = GetCurrentColumnValue("tipo") == null ? "tipo vacaciones" : GetCurrentColumnValue("tipo").ToString();
