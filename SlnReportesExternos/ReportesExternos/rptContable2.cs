...
namespace ReportesExternos
{
    public partial class rptContable2 : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private void xrTableCell9_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            if (Rep.num1 == 1)
            {
                if (GetCurrentColumnValue("Col1") != null) 
                {
            ...
            if (Rep.c1 == "0" || (GetCurrentColumnValue("Col1") == null ? "0" : GetCurrentColumnValue("Col1").ToString()) == "0")
            {
                lbl.Text = "";
            }
        }
        ...
        private void xrTableCell10_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            if (Rep.num2 == 1)
            {
                if (GetCurrentColumnValue("Col2") != null)
                {
            ...
            if (Rep.c2 == "0" || (GetCurrentColumnValue("Col2") == null ? "0" : GetCurrentColumnValue("Col2").ToString()) == "0")
            {
                lbl.Text = "";
            }
        }
        ...
        private void xrTableCell11_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            if (Rep.num3 == 1)
            {
                if (GetCurrentColumnValue("Col3") != null)
                {
            ...
            if (Rep.c3 == "0" || (GetCurrentColumnValue("Col3") == null ? "0" : GetCurrentColumnValue("Col3").ToString()) == "0")
            {
                lbl.Text = "";
            }
        }
        ...
        private void xrTableCell12_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            if (Rep.num4 == 1)
            {
                if (GetCurrentColumnValue("Col4") != null)
                {
            ...
            if (Rep.c4 == "0" || (GetCurrentColumnValue("Col4") == null ? "0" : GetCurrentColumnValue("Col4").ToString()) == "0")
            {
                lbl.Text = "";
            }
        }
        ...
        private void xrTableCell13_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            if (Rep.num5 == 1)
            {
                if (GetCurrentColumnValue("Col5") != null)
                {
            ...
            if (Rep.c5 == "0" || (GetCurrentColumnValue("Col5") == null ? "0" : GetCurrentColumnValue("Col5").ToString()) == "0")
            {
                lbl.Text = "";
            }
        }
        ...
        private void xrTableCell14_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            if (Rep.num6 == 1)
            {
                if (GetCurrentColumnValue("Col6") != null)
                {
            ...
            if (Rep.c6 == "0" || (GetCurrentColumnValue("Col6") == null ? "0" : GetCurrentColumnValue("Col6").ToString()) == "0")
            {
                lbl.Text = "";
            }
        }
        ...
        private void xrTableCell15_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            if (Rep.num7 == 1)
            {
                if (GetCurrentColumnValue("Col7") != null)
                {
            ...
            if (Rep.c7 == "0" || (GetCurrentColumnValue("Col7") == null ? "0" : GetCurrentColumnValue("Col7").ToString()) == "0")
            {
                lbl.Text = "";
            }
        }
        ...
        private void xrTableCell16_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            if (Rep.num8 == 1)
            {
                if (GetCurrentColumnValue("Col8") != null)
                {
            ...
            if (Rep.c8 == "0" || (GetCurrentColumnValue("Col8") == null ? "0" : GetCurrentColumnValue("Col8").ToString()) == "0")
            {
                lbl.Text = "";
            }
        }
